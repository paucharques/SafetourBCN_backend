...
app.post('/registerEstablishment', async (req, res) => {
    ...
    try{
        conn = await pool.getConnection();
        conn.query('INSERT INTO ESTABLISHMENT VALUES(?,?,?,?,?,?,?);', [req.body.owner, null, req.body.local_x, req.body.local_y, req.body.description, req.body.max_capacity, req.body.schedule])
